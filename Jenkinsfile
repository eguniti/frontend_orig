node{
    ...
    stage('Build Image and push to ECR'){
        ...
        sh 'docker tag frontend/$JOB_NAME:v1.$BUILD_NUMBER 905418334887.dkr.ecr.us-east-1.amazonaws.com/frontend:v1.$BUILD_NUMBER'
        ...
        sh 'docker push 905418334887.dkr.ecr.us-east-1.amazonaws.com/frontend:v1.$BUILD_NUMBER'
    }
}
